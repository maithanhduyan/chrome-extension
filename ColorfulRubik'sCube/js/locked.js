ERNO.Locked = function ( cube, camera, domElement ) {
 ...
 function onInteractStart( event ){
	...
	//console.log("mousedown function onInteractStart - when rotating the cube in space only, but also fires at start of rotating rows and columns");
 ...
 function onInteractMove( event ){
	 //chris added...this is the mouseup when moving rows and columns
	//console.log("mousemove function onInteractMove - when rotating the cube in space only");
 ...
 function onInteractEnd( event ){
	 //chris added...this is the mouseup when moving rows and columns
	//console.log("mouseup function onInteractEnd - when rotating the cube in space only");
